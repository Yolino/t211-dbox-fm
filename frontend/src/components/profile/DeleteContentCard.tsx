...
interface DeleteContentCardProps {
  title: string;
  onDeleteContent: () => void;
  onClose: () => void;
}

const DeleteContentCard = ({ title, onDeleteContent, onClose }: DeleteContentCardProps) => {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white p-8 rounded-xl shadow-2xl w-96 relative">
        ...
        <div className="flex justify-end gap-4">
          <button onClick={onDeleteContent} className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400">Yes</button>
